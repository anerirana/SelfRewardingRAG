...
class LLM(nn.Module):
    ...
    def forward(self, prompt, temp=0.7, min_new_tokens=100):
        ...
        outputs = self.model.generate(inputs, temperature=temp, top_k=0, top_p=1.0, repetition_penalty=1.4, min_new_tokens=min_new_tokens, max_new_tokens=4096, do_sample=True)
